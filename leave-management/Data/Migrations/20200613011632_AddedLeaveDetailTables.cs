        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveTypeId = table.Column<int>(name: "LeaveType Id", nullable: true),
                    LeaveTypeId0 = table.Column<int>(name: "LeaveTypeId", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveAllocations_LeaveTypes_LeaveType Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveTyepId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveHistories_LeaveTypes_LeaveTyepId",
                        column: x => x.LeaveTyepId,
                        principalTable: "LeaveTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveAllocations_LeaveType Id",
                table: "LeaveAllocations",
                column: "LeaveType Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveHistories_LeaveTyepId",
                table: "LeaveHistories",
                column: "LeaveTyepId");
